...
static int dwc3_qcom_connector_check(const struct fwnode_handle *fwnode)
{
...
static void *dwc3_qcom_find_usb_connector_match(const struct fwnode_handle *fwnode,
